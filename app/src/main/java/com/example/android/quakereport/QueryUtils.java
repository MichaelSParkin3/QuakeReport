...
public final class QueryUtils {
    ...
    public static void setRealJsonResponse(String realJsonResponse) {
        REAL_JSON_RESPONSE = realJsonResponse;
    }

    public static String REAL_JSON_RESPONSE = "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&eventtype=earthquake&orderby=time&minmag=6&limit=10";
    ...
    public static List<Earthquake> fetchEarthquakeData(String requestUrl) {
        Log.e(LOG_TAG, "fetchEarthquakeData activated");
        // Create URL object
