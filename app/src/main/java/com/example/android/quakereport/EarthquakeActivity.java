...
public class EarthquakeActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Earthquake>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Loading spinner
        ProgressBar spinLoading = (ProgressBar) findViewById(R.id.spinner);
        ...
        if (isConnected) {
            ...
            Log.e(LOG_TAG, "initLoader activated");
            loaderManager.initLoader(EARTHQUAKE_LOADER_ID, null, this);


            //Set empty state view onto ListView
    ...
    public Loader<List<Earthquake>> onCreateLoader(int i, Bundle bundle) {
        Log.e(LOG_TAG, "onCreateLoader activated");
    ...
    public void onLoadFinished(Loader<List<Earthquake>> loader, List<Earthquake> earthquakes) {
        ...
        ProgressBar spinLoading = (ProgressBar) findViewById(R.id.spinner);
        spinLoading.setVisibility(View.GONE);
        emptyView.setText("Sorry no earthquakes found.");

        Log.e(LOG_TAG, "onLoadFinished activated");
    ...
    public void onLoaderReset(Loader<List<Earthquake>> loader) {
        Log.e(LOG_TAG, "onLoaderReset activated");
